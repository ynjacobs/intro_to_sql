...
COPY animals (name, number_of_legs, flying, swimming, egg_laying) FROM stdin;
cat	4	f	f	f
hammerhead shark	0	f	t	f
octopus	8	f	t	t
duck	2	t	t	t
sheep	4	f	f	f
bat	2	t	f	f
...
COPY board_games (name, max_players, min_players, category, mins_to_play) FROM stdin;
Arkham Horror	8	1	strategy	240
Dixit	6	3	party	30
Carcassonne	5	2	light strategy	45
Quarto	2	2	abstract	20
7 Wonders	7	2	strategy	30
Agricola	5	1	strategy	120
Bohnanza	7	2	light strategy	45
Cards Against Humanity	30	5	party	30
Game of Things	15	2	party	45
Sushi Go	5	2	party	15
Quixo	4	2	abstract	15
7 Wonders	7	2	strategy	30
\.
...
COPY recipes (vegan, vegetarian, nut_free, gluten_free, name, serves, minutes_required, description, ingredients) FROM stdin;
...
COPY robots (name, source, personality) FROM stdin;
GLaDOS	Portal	passive-aggressive
WALL-E	WALL-E	curious
Marvin	The Hitchhiker's Guide to the Galaxy	pessimistic
C3PO	Star Wars	anxious
Mr. Butlertron	Clone High	compassionate
Ava	Ex Machina	clever
Deep Thought	The Hitchhiker's Guide to the Galaxy	thorough
R2D2	Star Wars	loyal
\.
